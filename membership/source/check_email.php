...
<body>
	<div id=wrap>
		<div id=id_check_title>
			<div id=id_check_title1>이메일 인증</div>
			<div id=id_check_title2>
				<!-- 이메일 인증 창 닫기 -->
				<a href="#"><img src="../image/pop_login_close.gif" onclick="closer()"></a>
			</div>
		</div>
		<div class=clear></div>
		<div id=hr_line></div>
		...
		<form name=email_check_form method="post" action="../PHPmailer/email.php">
    		<div align=center>
    			...
    			<a href="#">
    				<!-- 인증번호 받기 이미지 버튼 -->
    				<img src="../image/email_conf_receive.jpg" onclick="check_email_conf()">
    			</a>
    		</div>
		</form>
		<br>
